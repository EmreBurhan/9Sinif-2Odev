...
**Cevap:** *Ölçüm sırasında 0 noktasını belirlerken ufak bir kayma olmuş olabilir.*
...
**Cevap**: *Sanırım soldaki (saç,gömlek,papyon ve çoraplar hariç)*
...
**Cevap**: *Noktaları tamamen kesen bir doğru çizemediğimden 2 farklı yerden hesapladım. Videodaki değer daha uzak olan =* ***666,66...***. *Videodaki değere daha yakın olan ise =* ***659,0909...***.
...
**Cevap:** *Değerler yakın mı emin değilim ben eğim olarak* ***-5*** buldum ama bilgisayar ***-4,37*** *buldu. Denklem olarak ise ben* ***y= -5x-2,25*** *buldum. Bilgisayar ise* ***y= -4,37-2,07*** *buldu. Grafiğime* [BURADAN]( https://docs.google.com/spreadsheets/d/1VaOA9GFJ-3H953PR5aIphNpzVAWcC8xGG_pwszcc0hA/edit?usp=sharing  ) *ulaşabilirsiniz.* 
